...
response0 = urllib.urlopen.urlopen(genreURL)
...
def populate_movies():
	...
	if not popmovie:					
		...
		for i in range(1,501):
			...
			response0 = urllib.urlopen.urlopen(popurl) 	
...
def index(request):
	...
	if not nowmovie:
		...
		response0 = urllib.urlopen.urlopen(nowurl)
	...
	if not topmovie:
		...
		response0 = urllib.urlopen.urlopen(topurl)
	...
	if not upmovie:
		...
		response0 = urllib.urlopen.urlopen(upurl)
	...
	if not airtodayshow:
		...
		response0 = urllib.urlopen.urlopen(airtodayurl)
	...
	if not airshow:
		...
		response0 = urllib.urlopen.urlopen(airurl)
...
def movie(request, movie_id):
	if request.user.is_authenticated():	
		...
		if not mov:
			...
			response0 = urllib.urlopen.urlopen(movurl)
		...
		if not movcred:
			...
			response0 = urllib.urlopen.urlopen(movcredurl)
		...
		if not movsim:
			...
			response0 = urllib.urlopen.urlopen(movsimurl)
		...
		if not movrev:
			...
			response0 = urllib.urlopen.urlopen(movrevurl)
		...
		response0 = urllib.urlopen.urlopen(movtraiurl)
...
def show(request, show_id):
	if request.user.is_authenticated():	
		...
		if not showdet:
			...
			response0 = urllib.urlopen.urlopen(showurl)
		...
		if not showsim:
			...
			response0 = urllib.urlopen.urlopen(showsimurl)
		...
		if not showcred:
			...
			response0 = urllib.urlopen.urlopen(showcredurl)
		...
		if not showkey:
			...
			response0 = urllib.urlopen.urlopen(showkeyurl)
			...
			if query:
				if t=='movie':
					...
					if not s_movies: 
						...
						response = urllib.urlopen.urlopen(url)
